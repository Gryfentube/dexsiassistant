...
bot.on('message', message => {
    ...
    if (message.channel.id === annPoDXSIY){
        bot.channels.get(annDXSIY).sendMessage({embed: {color: 0xff0080, fields: [{name: "ANNONCE", value: value}]}}) //annonce
            .then(bot.channels.get(consauleDXSIY).sendMessage({embed: {color: 0xff0080, author: {name: "Nouvelle annonce envoyé par " + author,
                                                               icon_url: "https://cdn.discordapp.com/icons/441664261454823444/1cced0ad87913d0d5232dce11bedb70f.png"},
