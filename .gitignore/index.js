...
bot.on("guildMemberRemove", member => { //Quand un membre quitte dans le serveur
    ...
    aurevoirDXSIY.sendMessage('**' + member.displayName + '** nous a quitté paix à son âme ' + sad) //envoie le message de aurevoir
